...
namespace Day09 {
    internal static class Day09 {
            ...
            for (int i = 0; i < field.GetLength(0); i++) {
                for (int j = 0; j < field.GetLength(1); j++) {
                    ...
                    (up, right, down, left, current) =
                        (int.MaxValue, int.MaxValue, int.MaxValue, int.MaxValue, field[i, j]);
        ...
        static string Solve02(int[,] field) {
            ...
            return  (basinsizes[^1] * basinsizes[^2] * basinsizes[^3]).ToString();
        }
